...
@section('content')
    ...
    <div class="container">
        <div class="col-12 col-lg-8 ">
            <div class="card d-flex justify-content-center align-items-center vh-50">
                <div class="card-body">
                    <label class="form-check-label font-bold d-block">Change Theme</label>
                    <div class="theme-toggle d-flex align-items-center mt-2">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            aria-hidden="true" role="img" class="iconify iconify--system-uicons" width="40"
                        ...
                        <div class="form-check form-switch fs-6 ml-3">
                            <input class="form-check-input  me-0" type="checkbox" id="toggle-dark" style="cursor: pointer">
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            aria-hidden="true" role="img" class="iconify iconify--mdi" width="30" height="20"
